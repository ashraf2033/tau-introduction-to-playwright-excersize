...
- Name: search.spec.ts >> Search Scenarios >> Navigate to getting started from search 
- Location: tests/search.spec.ts:15:9
...
- button "Search" [expanded]:
  - banner:
    - text: Search
    - searchbox "Search": getting started
...
```ts
  ...
  2  | 
  3  | export class GettingStartedPage {
  ...
  12 | 
  13 | 
  14 | async assertPageHeading(){
  15 |      // Expects page to have a heading with the name of Installation.
> 16 |       await expect(this.page.getByRole('heading', { name: 'Installation' })).toBeVisible();
     |                                                                              ^ Error: expect(locator).toBeVisible() failed
  17 | }
  18 | 
  19 | 
  20 | async assertDotNetTitle(){
  21 |         await expect(this.page.getByText('dotnet build')).toBeVisible();
  22 | 
  23 | }
  24 | }
  25 | 
  26 | export default GettingStartedPage;
  27 | 
```